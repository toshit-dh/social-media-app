        ...
        <div className="form">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <input
              ...
              onChange={(e) => handleTextChange(e)}
            />
            <label htmlFor="private public">Account Type:</label>
            <div className="radio">
              <div className="private">
                <input
                  ...
                  name="options"
                  value="option1"
                  checked={texts.accountType === "Private"}
                  onChange={() =>
                    setTexts({ ...texts, accountType: "Private" })
                  }
                />
              ...
              <div className="public">
                <input
                  ...
                  name="options"
                  value="option2"
                  checked={texts.accountType === "Public"}
                  onChange={() => setTexts({ ...texts, accountType: "Public" })}
                />
